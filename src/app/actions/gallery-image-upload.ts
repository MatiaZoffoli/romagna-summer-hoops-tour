...
/** Upload a gallery image file; returns public URL or error. Max 3 per tappa enforced by caller. */
export async function uploadGalleryImageFile(formData: FormData): Promise<{ url?: string; error?: string }> {
